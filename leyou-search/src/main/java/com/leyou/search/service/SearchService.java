...
public class SearchService {
    ...
    public PageResult<Goods> search(SearchRequest request) {
        ...
        // 执行搜索，获取搜索的结果集
        AggregatedPage<Goods> goodsPage = (AggregatedPage<Goods>)this.reponsitory.search(queryBuilder.build());
    ...
    private List<Map<String,Object>> getParamAggResult(Long id, QueryBuilder basicQuery) {
        ...
        // 查询要聚合的规格参数
        List<SpecParam> params = this.specClient.queryParams(null, id, null, true);
        // 添加聚合
        params.forEach(param -> {
